...
- Reliable
  - "…the degree to which a test or measure produces the same scores when applied in the same circumstances…" Thomas (1996)
  - In other words, if you take the measure again, will you get the same result?
--

- Valid
    - "Degree to which a test or instrument measures what it purports to measure" Thomas (1996)
