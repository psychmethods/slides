...
- Distinguish between a sample distribution and a sampling distribution
- Explain how sample size affects the standard error
- State the Law of Large Numbers and describe its implications
- Apply the Central Limit Theorem to explain why sample means tend to be normally distributed
- Use sampling distributions to evaluate statistical significance
...
```{r studentt, echo=FALSE, out.width="95%"}
...
sigma <- 10
n <- 1:1000
xbar <- sapply(n, function(n) mean(rnorm(n, mu, sigma)))
plot(n, xbar, type = "l", xlab = "Sample Size", ylab = "Sample Mean", main = "Law of Large Numbers")
...
# dice roll 1-6
n <- 1:1000
xbar <- sapply(n, function(n) mean(sample(1:6, n, replace = TRUE)))
plot(n, xbar, type = "l", xlab = "Sample Size", ylab = "Sample Mean", main = "Law of Large Numbers (Dice Roll)")
