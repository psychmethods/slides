...
- Create and interpret frequency distributions, bar charts, and histograms
- Describe a distribution in terms of its shape, center, spread, and outliers
- Match the appropriate graph type to the level of measurement
- Evaluate data visualizations for clarity and accuracy
