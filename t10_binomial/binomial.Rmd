...
- Identify whether a situation meets the requirements for a binomial distribution
...
- Apply the normal approximation to binomial distributions when appropriate
