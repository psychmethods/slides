...
- Constructing CIs using the t-distribution
...
- Define a confidence interval and explain what "confidence" means
- Calculate a confidence interval for a population mean using the t-distribution
- Correctly interpret a confidence interval (and avoid common misinterpretations)
- Explain how sample size and confidence level affect interval width
