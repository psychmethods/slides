...
- Distinguish between paired and independent two-sample t-tests
- Select the appropriate t-test design for a given research scenario
- Calculate and interpret a paired-samples t-test
- Calculate and interpret an independent-samples t-test
...
# Ho: mu1 = mu2
t.test(treeVolume_t1,treeVolume_t2,paired=TRUE )
