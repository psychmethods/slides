...
- Interpreting and critiquing correlations

--

**By the end of this lecture, you should be able to:**

- Create and interpret scatterplots to describe bivariate relationships
- Calculate and interpret Pearson's correlation coefficient
- Identify limitations of correlation (linearity, outliers, range restriction)
...
- The population correlation is the sum of cross-products of z-scores divided by n:
