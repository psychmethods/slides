...
- Regression is a statistical method that allows us to understand how the DV changes as the IV changes.    
---
...
# Plotting Smoking and Lung Capacity

.pull-left[
- When we plotted these data, we found a negative linear association between the number of cigarettes smoked and lung capacity.
]
...
- This high percentage means that when we know how many cigarettes someone consumes, we can predict lung capacity.
...
- In more sophisticated language, we fit a linear model of the relationship between $x$ and $y$
...
- Several methods exist, but the most popular is the least-squares approach.
...
# Calculating Regression Line for Smoking Data: Slope
